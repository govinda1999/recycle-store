...
<html lang="en">
  ...
  <body>
    ...
    <div style="background-color: rgba(0,0,0,0.5)">
      <div class="container-fluid land" style="height:94vh">
        <div class="row justify-content-center">
          <div class="col-10">
            <p
              class="text-white text-center  text-capitalize text-justify font-play text-transparent"
              style="padding-top:25%;font-size: 250%;"
            >
    ...
    <div class="container mt-5">
      <div class="mb-5">
        <p
          class="text-center text-secondary font-dance"
        ...
        <div class="col-md-6 col-12 mb-5">
          <div class="p-2">
            <iframe
              width="100%"
              height="315"
              src="https://www.youtube.com/embed/HkHEJEzMKwc"
              frameborder="0"
              allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
            ></iframe>
    ...
    <div class="container mt-5">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-3 col-md-5 col-12 mb-5" style="height:275px">
          <img
            src="./image/shopping-bag-931293_1920.jpg"
        ...
        <div class="col-lg-3 col-md-5 col-12 mb-5" style="height:275px">
          <img
            src="./image/trash-1428113_1920.jpg"
            style="width:100%;height: 100%;"
            class="img-fluid image-hover"
            alt="Trash"
          />
        ...
        <div class="row justify-content-center">
          <div class="col-md-4 col-10 mb-5 mt-5 text-white">
            <p>
              ...
              ><span class="pl-3">Kjsce Vidyavihar, Mumbai</span>
            </p>
            <p>
            ...
            <p>
              ...
              ><span class="pl-3 text-primary">support@company.com</span>
            </p>
          </div>
          <div class="col-md-4 col-10 mb-5 mt-5 text-white">
            <div>
            ...
            <a href="https://facebook.com" target="blank" class="text-secondary"
