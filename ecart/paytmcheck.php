        ...
        <table border="1">
            <tbody>
                ...
                <tr>
                    ...
                    <td><input id="CUST_ID" tabindex="2" maxlength="12" size="12" name="CUST_ID" autocomplete="off" value="<?php echo $_SESSION['id']; ?>"></td>
                </tr>
                <tr>
                    <td>3</td>
                ...
                <tr>
                    ...
                    <td><input title="TXN_AMOUNT" tabindex="10" type="text" name="TXN_AMOUNT" value="<?php echo $_POST["amt"]; ?>">
                    </td>
                </tr>
                <tr>
                    <td></td>
